...
remove_from_excluded_button = 'Снова показывать'
allergies_button = 'Аллергии'

# MESSAGES

# TODO add link
accept_policy_message = ('Добро пожаловать. Для регистрации, пожалуйста, '
...
request_diet = 'Рецепт из какой диеты вы хотите получить?'
recipe = ('{title}\n'
          '{description}\n'
          '{ingredients}')
...
favorite_recipes = 'Ваши избранные рецепты:'
favorite_recipes_none = ('Здесь будут ваши сохраненные рецепты. '
                         f'Нажмите "{add_to_favorites_button}" на карточке рецепта, '
                         'чтобы сохранить его в эту секцию.')
excluded_recipes = 'Ваши скрытые рецепты:'
excluded_recipes_none = ('Здесь будут ваши скрытые рецепты. '
                         f'Нажмите "{exclude_recipe_button}" на карточке рецепта, '
                         'чтобы сохранить его в эту секцию.')
